...
public class ForceSolver2 extends AbstractLinearSolver {
    ...
    protected ResultType doSolve() {
        ...
        try {
            ...
            allVariableForceMap.clear();
            variableForceMap.clear();
        }
    }
    ...
    private Map<Variable, VariableForce> allVariableForceMap = new HashMap<Variable, VariableForce>();
    ...
    private VariableForce getVariableForce(Variable variable) {
        VariableForce variableForce = allVariableForceMap.get(variable);
        if (variableForce == null) {
            variableForce = new VariableForce();
            allVariableForceMap.put(variable, variableForce);
        }
        return variableForce;
    }
